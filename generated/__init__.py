...
from generated.cdc_messages import Msg131, Msg1A0  # noqa: F401
...
ALL_MESSAGES: dict[int, type] = {
    ...
    for cls in (
        ...
        Msg2B6, Msg336, Msg3B6, Msg52D, Msg12B, Msg131,
        Msg1A0, Msg12D, Msg1D0, Msg1E3, Msg1A3, Msg223,
        Msg323, Msg0E1, Msg0A4, Msg165, Msg1A5, Msg1E0,
        Msg1E5, Msg225, Msg265, Msg2A5, Msg3E5, Msg221,
        Msg2A1, Msg261,
    )
}
